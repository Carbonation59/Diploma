...
int main(int argc, char *argv[]) 
{
    ...
    try
    {
        ...
        for(int i = 0; i <= 700; i = i + 25){
            info << (double)i / (double)prob_of_loss_den << ' ';
        }
        info << '\n';
        for(int n_calls = 10; n_calls <= 10000; n_calls = n_calls * 10){
            ...
            vector<double> prec;
            for(int prob_of_loss_num = 0; prob_of_loss_num <= 700; prob_of_loss_num = prob_of_loss_num + 25){
                cout << prob_of_loss_num << ' ' << n_calls << '\n';
                generate_info(session, n_calls, prob_of_loss_num);             
