...
const double q_cf = 30;                            // итоговый множитель
const int n = 10;                                  // количество устройств в сети +1 (здесь их 9) (+1 для учёта 1 индексации)
const int n_calls = 1000;                          // количество звонков
const int64_t un_tm_stmp_delay = 1707609600000;    // примерное время в миллисекундах с 01.01.1970 до 01.01.2024
const int64_t time_upper_bound = 15811200000;      // верхняя граница для времени в миллисекундах (полгода)
const int64_t max_dur_call = 1800000;              // максимальная продолжительность звонка в миллисекундах 
...
const int max_delay_dur = 25;                      // максимальная задержка по длительности звонка между соседними CDR'ами
